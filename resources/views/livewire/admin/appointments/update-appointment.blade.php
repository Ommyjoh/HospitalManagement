<div>
    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 fw-bold text-info"> Update Appointment</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item"><a href="{{ route('admin.appointments') }}">Appointments</a></li>
                <li class="breadcrumb-item active"> Update Appointments</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
        </div>
...
<!-- /.content-header -->
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form autocomplete="off" wire:submit.prevent="updateAppointment">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row col-lg-12 mt-2">
                                    <div wire:ignore class="form-group">
                                        ...
                                        <textarea id="note" data-note="@this" class="form-control" id="exampleFormControlTextarea1" rows="5">{!! $state['note'] !!}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <button id="submit" type="submit" class="btn btn-primary" value="Hellow"><i class="fa fa-save mr-1"></i>Save Changes</button>
                                </div>
                            </div>
                        </div>
                    </form>
